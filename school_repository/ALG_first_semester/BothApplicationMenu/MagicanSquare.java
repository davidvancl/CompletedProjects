...
public class MagicanSquare {
     ...
     */
    private boolean getMatrixValidation(int[][] matrix, int maxNumber) {
     ...
     */
    private boolean sortOneDimensionalArrayAndCompare(int[] array) {
