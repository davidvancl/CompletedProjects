 ...
 *
 * @file BannedWords.java
 * @brief Pole zakázaných slov.
 *
 * @class BannedWords
 * @brief Abstraktní třída se zakázanými slovy.
 */
public abstract class BannedWords {
    /**
     * Zakázané slova.
     * V dokumentaci odstraněno kvuli vulgárním výrazům.
     */
    public static String[] bannedWords = {"4r5e", "5h1t", "5hit", "a55", "anal", "anus", "ar5e", "arrse", "arse", "ass", "ass-fucker", "asses", "assfucker",
